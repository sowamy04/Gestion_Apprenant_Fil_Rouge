...
class ApiController extends AbstractController
{
  ...
  /**
   * @Route("/api/deleteProfil/{id}", name="delete_profil")
   *
   * @param Request $request
   * @return void
   */
  public function deleteProfil(Request $request, SerializerInterface $serializer, Profil $profil, ManagerRegistry $manager)
  { $jsonRecu = $request->getContent();
