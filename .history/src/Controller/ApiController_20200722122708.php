...
class ApiController extends AbstractController
{
  ...
  /**
   * @Route("/api/deleteProfil/{id}", name="delete_profil", methods={"POST"})
   *
   * @param Request $request
   * @return void
   */
  public function deleteProfil(Request $request, SerializerInterface $serializer, EntityManagerInterface $em)
  {
    $jsonRecu = $request->getContent();
    dd($request['id']);
    try {
